...
- **Review cadence:** Quarterly, or after any material change to customer-facing policies or operating model

### Change log
| Date | Version | Summary of change | Owner |
|---|---:|---|---|
| 2026-01-26 | 1.0 | Initial business purpose baseline created | Product owner / business owner |
